...
router.get(['/product','/pagenum=:pno'],admin.product);//상품관리페이지
...
router.post("/simgdb2",upload.single('simg2'),admin.simgupload2); //썸네일업로드
...
router.post('/faqupload',admin.faquploadpost); //faq등록
